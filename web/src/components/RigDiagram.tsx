  ...
  paternoster: {
    ...
    svg: (
      <svg viewBox="0 0 120 170">
        ...
        <Label x={58} y={158}>sinker on the bottom</Label>
      </svg>
    ),
  },
  livebait_float: {
    ...
    svg: (
      <svg viewBox="0 0 120 170">
        ...
        <Label x={60} y={166} anchor="middle">live yakka pinned near the hook</Label>
      </svg>
    ),
  },
  squid_jig: {
    ...
    svg: (
      <svg viewBox="0 0 120 170">
        ...
        <Label x={74} y={30}>leader, no swivel</Label>
        <Label x={74} y={92}>2.5–3.5 jig</Label>
        <Label x={60} y={150} anchor="middle">spikes — no hook to set</Label>
      </svg>
    ),
  },
  float_rig: {
