    ...
    <main className="wrap">
      ...
      <div className="prose">
        ...
        <ol style={{ paddingLeft: 20 }}>
          ...
          <li>Each factor is converted to a 0–100 <em>subscore</em> through a response curve — e.g. swell of 0.8 m scores high for rock fishing, 2.5 m scores near zero.</li>
